...
class SimulatePlanAppIT extends WordSpec with Matchers with TypeCheckedTripleEquals{
  "SimulatePlanAppIT.strMain" should {
    ...
    "return an error when the period exceeds the return bounds" in {
      ...
      val expectedResult = "Cannot get the return for the month 780. Accepted range: 0 to 779"
...
//      val result = SimulatePlanApp.strMain(
//        Array(
//          "1952.09:2017.09", "25.0", "60", "3'000", "2000.0", "10000"
//        )
//      )
//
//      result should === (
